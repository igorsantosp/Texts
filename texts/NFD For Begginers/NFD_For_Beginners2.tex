...
\begin{center}
\LARGE\textsf{João Igor Pereira}\par
\bigskip
\normalsize\textsf{Universidade Federal do Pará}\par
\medskip
...
\newcommand*{\THPress}{LASSE - 5G and IoT Research Group}%
\begin{center}
\settowidth{\droptitle}{\textsf{\THPress}}%
\textrm{\normalsize \THP} \\
\textsf{\THPress} \\[0.2\baselineskip]
\includegraphics[width=\droptitle]{anvil2.mps} %LASSE LOGO
...
{\raggedleft{\scshape João Igor Pereira} \\ LASSE - 5g and IoT reseach group , PA \\ March 2017\par}
